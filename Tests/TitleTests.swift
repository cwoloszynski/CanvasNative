...
final class TitleTest: XCTestCase {
	func testTitle() throws {
		let node = try AssertNotNilAndUnwrap(DocumentTitle(string: "⧙doc-heading⧘Hello", range: NSRange(location: 0, length: 18)))
	...
	func testInline() throws {
		let node = try AssertNotNilAndUnwrap(Parser.parse("⧙doc-heading⧘Hello **world**").first! as? DocumentTitle)
